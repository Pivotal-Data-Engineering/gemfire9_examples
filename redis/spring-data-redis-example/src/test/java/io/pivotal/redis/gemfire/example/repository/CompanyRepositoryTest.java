...
//			.around(RequiresRedisServer.onLocalhost().atLeast("3.2"));
	...
	public void saveSingleEntity() {
		...
		assertThat(operations.execute(
				(RedisConnection connection) -> connection.exists(new String("persons:" + nylaInc.getId()).getBytes(CHARSET))),
				is(true));
	}
	...
	public void findByReturingPage() {
		...
		Page<Company> page1 = repository.findByContact(nylaInc.getContact(),  new PageRequest(1, 5));
